package br.com.maxinfo.hardware.jsf.util;
...
public class JsfUtil {
    ...
    public static String getEmpresaLogada (){
         String empresaLogada = null;        
         HttpServletRequest req = null;        
         req = (HttpServletRequest) FacesContext.getCurrentInstance().getExternalContext().getRequest();
         UsuarioController usuarioLogado = (UsuarioController) req.getSession().getAttribute("usuarioController"); 
         empresaLogada = usuarioLogado.getUsuarioLogado().getEmpresa().getEmail();
    ...
    public static void logOut (){
     ...
     public static Empresa getEmpresaDaSessao (){
         ...
         req = (HttpServletRequest) FacesContext.getCurrentInstance().getExternalContext().getRequest();
         UsuarioController usuarioLogado = (UsuarioController) req.getSession().getAttribute("usuarioController"); 
         return usuarioLogado.getUsuarioLogado().getEmpresa();
