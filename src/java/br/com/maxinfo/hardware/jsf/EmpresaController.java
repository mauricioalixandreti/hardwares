...
public class EmpresaController implements Serializable {
    ...
    @EJB
    private br.com.maxinfo.hardware.facade.EmpresaFacade ejbFacade;
...
//    }
    ...
    public String create() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/resources/propriedades/bundle").getString("EmpresaCreated"));
            return prepareCreate();
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/resources/propriedades/bundle").getString("PersistenceErrorOccured"));
            return null;
        }
    }
...
//    }
    ...
    public String update() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/resources/propriedades/bundle").getString("EmpresaUpdated"));
            return "View";
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/resources/propriedades/bundle").getString("PersistenceErrorOccured"));
            return null;
...
//    }
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/resources/propriedades/bundle").getString("EmpresaDeleted"));
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/resources/propriedades/bundle").getString("PersistenceErrorOccured"));
        }
    }
