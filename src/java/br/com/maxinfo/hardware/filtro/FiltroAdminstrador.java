...
public class FiltroAdminstrador implements Filter, Serializable {
...
//        throw new UnsupportedOperationException("Not supported yet.");
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
        ...
        } else if (session.getUsuarioLogado().getTipoUsuario().equalsIgnoreCase("ADM")) {            
            chain.doFilter(request, response);
        }else{
           resp.sendRedirect(req.getServletContext().getContextPath() + "/adm/usuario/home.xhtml");
        } 
    }
